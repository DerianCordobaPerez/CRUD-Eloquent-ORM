    ...
    <div class="container">
        <div class="card-body">
            <div class="container">
                ...
                <form action="{{ url('/teachers') }}" method="POST" class="col-md-6" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="form-group">
                        <input type="text" class="form-control col-md-6" name="id" placeholder="ID" maxlength="10" required>
                    </div>
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control col-md-6" name="lastName" placeholder="Apellido" maxlength="10" required>
                    </div>
                    <div class="form-group">
